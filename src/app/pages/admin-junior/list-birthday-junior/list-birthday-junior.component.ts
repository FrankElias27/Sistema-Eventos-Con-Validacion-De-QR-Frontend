...
@Component({
  selector: 'app-list-birthday-junior',
  templateUrl: './list-birthday-junior.component.html',
  styleUrls: ['./list-birthday-junior.component.css']
})
export class ListBirthdayJuniorComponent implements OnInit {
