...
@Component({
  selector: 'app-validate-qrs',
  templateUrl: './validate-qrs.component.html',
  styleUrls: ['./validate-qrs.component.css']
})
export class ValidateQrsComponent implements AfterViewInit  {
